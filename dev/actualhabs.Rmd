...
par(opar); par(mar=1.1*c(1,1,4.1,1))
xrange <- range(events.alex.week$Value)/1000
breaks <- seq(from=xrange[1], to=xrange[2], length=9)
for(w in wmin+(0:10)) {
  ...
  plot(st_geometry(coast.marlselect), col="darkgreen", reset=FALSE, xlim=xlim.marlselect, ylim=ylim.marlselect)
