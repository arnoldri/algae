...
```{r warning=FALSE}
plot.sobj(sobj, type="polygons")
plot.sobj(sobj, type="volume")
plot.sobj(sobj, type="retention")
plot.sobj(sobj, type="residency")
plot.sobj(sobj, type="communication")
```
...
plot.sim(simlist, sobj, tlist, parlist, type="epoch")
plot.sim(simlist, sobj, tlist, parlist, type="carrying.density")
plot.sim(simlist, sobj, tlist, parlist, type="map.carrying.density")
sfreset(); 
plot.sim(simlist, sobj, tlist, parlist, type="carrying.mass")
plot.sim(simlist, sobj, tlist, parlist, type="map.carrying.mass")
sfreset(); 
plot.sim(simlist, sobj, tlist, parlist, type="bloom.initiation.probability")
plot.sim(simlist, sobj, tlist, parlist, type="map.bloom.initiation.probability")
plot.sim(simlist, sobj, tlist, parlist, type="map.number.of.initiations"); ##sfreset()
sfreset(); 
plot.sim(simlist, sobj, tlist, parlist, type="bloom.initiation.times")
plot.sim(simlist, sobj, tlist, parlist, type="innovation.biomass")
plot.sim(simlist, sobj, tlist, parlist, type="biomass.over.time")
plot.sim(simlist, sobj, tlist, parlist, type="concentration.over.time")
plot.sim(simlist, sobj, tlist, parlist, type="observed.concentration.over.time")
...
```{r}
plot.sim(simlist, sobj, tlist, parlist, type="map.concentration",t1=1,t2=5)
```
```{r}
xrange <- c(0,max(simlist$cmat))
nbreaks <- 11
breaks <- seq(from=xrange[1], to=xrange[2], length=nbreaks)
colvec <- colorRampPalette(c("light grey","red"))(nbreaks-1)
t <- 1
t <- 53
week <- tvec[t]
plot((sobj$polysf %>% mutate(concentration=simlist$cmat[t,]))['concentration'], 
     pal=colvec,breaks=breaks,
     main=paste0("Algal concentration in Week ",week),reset=FALSE)
```
